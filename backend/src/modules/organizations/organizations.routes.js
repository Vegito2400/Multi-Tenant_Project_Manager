...
const {createOrganization,getUserOrganizations,changeRole,addUser,getMembers}=require("./organizations.controller.js");
...
router.get("/members",authenticate,requireOrg,getMembers);
